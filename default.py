# -*- coding: utf-8 -*-
#------------------------------------------------------------
# kuchitv - Kodi Add-on by Juarrox (juarrox@gmail.com)
...
def main_list(params):
    ...
    try:
        ...
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('kuchitv', "XML no reconocido...", 3 , __art__+'icon.png'))
